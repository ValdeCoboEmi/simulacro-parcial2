...
int main(){
    ...
    cout << "Bienvenido a la calculadora de la tarifa de Luz Eléctrica" << endl;
    ...
    if (kWh >= 0 && kWh < 100)
    {
        ...
        cout << "Tiene un consumo de "<< kWh << " que es tarifa menor que equivale a ($0.25) y tiene que pagar: $" << (kWh*0.25) << endl;
    }
    else if (kWh >= 100 && kWh <= 200)
    {
        //Se imprime y el resultado se multiplica por el monto que va a la tarifa
        cout << "Tiene un consumo de "<< kWh << " que es tarifa medida que equivale a ($1) y tiene que pagar: $" << (kWh*1) << endl;
    }
    else if (kWh > 200)
    {
        //Se imprime y el resultado se multiplica por el monto que va a la tarifa
        cout << "Tiene un consumo de "<< kWh << " que es tarifa alta que equivale a ($2) y tiene que pagar: $" << (kWh*2) << endl;
    }
    else{
